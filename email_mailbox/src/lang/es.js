export default {
  ...
  settings: {
    ...
    manual_sync: {
      label: 'Sncronización manual',
      button: 'Sincronizar',
      tooltip:
        'Debes tener al menos un dispositivo adicional para utilizar la Sincronización Manual'
    }
  },
  sidebar: {
    compose: 'redactar',
  ...
  popups: {
    ...
    manual_sync: {
      ...
      paragraphs: {
        header:
          'Todos tus correos, contactos y etiquetas de este dispositivo serán reemplazados con la información del dispositivo con el que confirmes esta operación',
