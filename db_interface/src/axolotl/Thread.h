...
namespace CriptextDB {
  struct Thread {
    ...
    cJSON *toJSON(){
      ...
      cJSON_AddItemToObject(thread, "labelIds", cJSON_CreateString(CriptextDB::DBUtils::joinSet(labelIds).c_str));
      ...
      cJSON_AddItemToObject(thread, "emailIds", cJSON_CreateString(CriptextDB::DBUtils::joinVector(emailIds).c_str));
      cJSON_AddItemToObject(thread, "fileTokens", cJSON_CreateString(CriptextDB::DBUtils::joinVector(fileTokens).c_str));
      ...
      cJSON_AddItemToObject(thread, "recipientContactIds", cJSON_CreateString(CriptextDB::DBUtils::joinSet(recipientContactIds).c_str));
  ...
  string getThreadsByLabel(string dbPath, vector<int> rejectedLabels, int labelId, string date, int limit, int accountId);
} 
